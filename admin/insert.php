...
<body style="height:2000px">
  ...
  <div id="menu-second">
	...
	<section class="col-sm-12" style="margin:auto">
		<form action="?" method="POST" enctype="multipart/form-data">
			<input type="hidden" name="action" value="insert_process">
			<table class="table table-hover" style="width: 600px;margin:auto">
				<tr>
					<td width="100">Tiêu đề</td>
					<td width="500"><input type="text" name="title" class="form-control">
				</tr>
				<tr>
					<td>Hình ảnh</td>
				...
				<tr>
					<td colspan="2">
						<a href="?"><input type="button" class="btn btn-primary" value="Trở lại" style="background-color:#C6F"></a>
						<input type="submit" class="btn btn-success" value="Đăng tin tức">
					</td>
				</tr>
			</table>
		</form>
